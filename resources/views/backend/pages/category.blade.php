            ...
            <div class="col-md-10 m-auto">
                <div class="card">
                    <div class="card-header d-flex">
                        ...
                        <button class="btn btn-sm btn-primary add_btn ml-auto">Create Category+</button>
                    </div>
                    <div class="card-body">
...
@section('script')
    <script !src="">
        $('.edit_btn').click(function(){
            ...
            $('#catName').val(name);
            $('#modalForm').attr('action', '{{url('admin/category/update')}}'+'/'+id);
        ...
        $('.add_btn').click(function(){
            $('#createCat').modal('show');
            $('#catName').val('');
            $('#modalForm').attr('action', '{{route('admin.category.store')}}');
